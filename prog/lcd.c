...
conststatic uint16_t bottom_row_static[16] = {0x50, 0x3A, 0x78, 0x78, 0x78, 0x57, 0x20, 0x4D, 0x41, 0x58, 0x3A, 0x78, 0x78, 0x2E, 0x78, 0x43}; // "P:xxxW MAX:xx.xC"
...
const static uint16_t *lcd_status_messages[11] = {msg_pre_startup, msg_startup, msg_init_ok, msg_delay_startup_fail_therm, msg_init_fail_tco_ptc, msg_init_fail_startup, msg_fail_tco_ptc, msg_fail_gen_therm, msg_overheat, msg_recover, msg_preinit_fail_bad_read};

const static uint16_t msg_rhu_1[16] = {0x43, 0x50, 0x55, 0x31, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43}; 					// RHU 1 INFO CPU1               "CPU1       xx.xC"
const static uint16_t msg_rhu_2[16] = {0x43, 0x50, 0x55, 0x32, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43}; 					// RHU 2 INFO CPU2               "CPU2       xx.xC"
const static uint16_t msg_rhu_3[16] = {0x43, 0x48, 0x49, 0x50, 0x53, 0x45, 0x54, 0x00, 0x00, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43};                     // RHU 3 INFO MISC               "CHIPSET    xx.xC"
const static uint16_t msg_rhu_4[16] = {0x42, 0x4F, 0x41, 0x52, 0x44, 0x5F, 0x52, 0x41, 0x4D, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43};                     // RHU 5 INFO RAM                "BOARD_RAM  xx.xC"
const static uint16_t msg_rhu_5[16] = {0x44, 0x49, 0x4D, 0x4D, 0x73, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43}; 					// RHU 4 INFO DIMM_GRP           "DIMMs      xx.xC"
const static uint16_t msg_rhu_6[16] = {0x4D, 0x2E, 0x32, 0x00, 0x53, 0x53, 0x44, 0x00, 0x00, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43}; 					// RHU 7 INFO M.2_GRP            "M.2 SSD    xx.xC"
const static uint16_t msg_rhu_7[16] = {0x32, 0x2E, 0x35, 0x22, 0x00, 0x48, 0x44, 0x44, 0x00, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43}; 					// RHU 8 INFO SFF_GRP            "2.5" HDD   xx.xC"
const static uint16_t msg_rhu_8[16] = {0x4D, 0x45, 0x5A, 0x5A, 0x41, 0x4E, 0x49, 0x4E, 0x45, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43};                     // RHU 6 INFO MEZZ               "MEZZANINE  xx.xC"
const static uint16_t msg_rhu_9[16] = {0x4D, 0x41, 0x49, 0x4E, 0x42, 0x4F, 0x41, 0x52, 0x44, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43};                     // RHU 9 INFO ADDITIONAL SENSORS "MAINBOARD  xx.xC"
const static uint16_t msg_rhu_10[16] = {0x4D, 0x41, 0x49, 0x4E, 0x42, 0x4F, 0x41, 0x52, 0x44, 0x00, 0x00, 0x78, 0x78, 0x2E, 0x78, 0x43};                    // RHU 9 INFO ADDITIONAL SENSORS "ADDITIONAL xx.xC"
